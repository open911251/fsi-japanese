...
**目前進度**（2026-08-10 更新，課次重整後）：全教材已擴展成50課對齊大家的日本語，除第46、47課外全數已補上完整內容（皆獨立agent審查過）。**第46、47課卡住，需要使用者決定怎麼處理**：這兩課原本規劃的文法點（ところです／たばかり／はず、そうです伝聞／ようです）審查時發現**已經被第28、43課的既有內容涵蓋掉**（第28課「今、出かけるところです」跟第43課「来ると言っていましたから、来るはずです」等句子，是重整時把舊課次內容整批搬過去、沒注意到內容已經涵蓋了這兩個later課次要教的東西），不是草稿品質問題，是這兩個課次插槽的文法點選擇本身需要重新設計，細節見ROADMAP #22。優先度與對照表見 `C:\Users\open9\.claude\plans\robust-inventing-crane.md`。舊28課的內容擴充進度（重整前）：`sub` 句型缺口第3-13課已補完（全教材句型數41→52、代換詞226個），第14課（現對齊新第14課）以後的舊課次還沒補；`trans` 轉換操練第1、2課已完成（新第1、2課），其餘還沒做。**接下來擴充要優先處理pending骨架課次**（照上面五步走，一次只挑1-3個pending課次，不要一次衝完全部剩下的20個）。
