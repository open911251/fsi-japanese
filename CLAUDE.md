...
**目前進度**（2026-08-10 更新，課次重整後）：全教材已擴展成50課對齊大家的日本語，第15、16、20、23、24、26、29、32、33、34、35、36、38、39、40、41、42課已補上完整內容（皆獨立agent審查過），**剩5課是`pending:true`骨架（無內容：44、45、46、47、50課）**，優先度與對照表見 `C:\Users\open9\.claude\plans\robust-inventing-crane.md`。持續小批擴充中，每批送獨立agent審查後才寫入。舊28課的內容擴充進度（重整前）：`sub` 句型缺口第3-13課已補完（全教材句型數41→52、代換詞226個），第14課（現對齊新第14課）以後的舊課次還沒補；`trans` 轉換操練第1、2課已完成（新第1、2課），其餘還沒做。**接下來擴充要優先處理pending骨架課次**（照上面五步走，一次只挑1-3個pending課次，不要一次衝完全部剩下的20個）。
